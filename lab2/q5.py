 ...
 with tf.Session() as sess:
   ...
   for ii in range(EPOCHS+1):
        ...
        if ii % PRINT_STEP == 0:
         ...
         print ('iteration :' + str (ii) + ',' + 'training cost:' + str (cost)+','+'learning rate:'+str(learning_rate))
       ...
       # print the fianl result in interations equal to 5000
         if ii == 1000:
           ...
           worksheet.write (0, col , 'learning_rate')
           ...
           worksheet.write (row+1, col , str (learning_rate))
